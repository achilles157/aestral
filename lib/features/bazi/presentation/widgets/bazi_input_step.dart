    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          GlassCard(
            ...
            child: Row(
              children: [
                ...
                Text(
                  includeHour ? 'Sertakan jam lahir' : 'Lewati — jam tidak diketahui',
          ...
          if (includeHour) ...[
            ...
            GlassCard(
              ...
              child: Column(
                ...
                children: [
                  Text('Jam lahir (waktu lokal setempat)',
                      ...
                      TextButton(
                        onPressed: () async {
                          final picked = await showTimePicker(
                            context: context,
                            initialTime: TimeOfDay(hour: birthHour ?? 12, minute: 0),
          ...
          // ── Gender ────────────────────────────────────────────────────
          Text('Jenis Kelamin (Opsional)',
              style: GoogleFonts.playfairDisplay(
                  fontSize: 20, color: Colors.white, fontWeight: FontWeight.bold)),
          const SizedBox(height: 6),
          Text('Diperlukan untuk menghitung siklus 10 tahun Luck Pillars (大運).',
              style: GoogleFonts.outfit(fontSize: 12, color: Colors.white60, height: 1.5)),
          const SizedBox(height: 16),
          Row(
            children: [
              _GenderChip(
                  label: 'Pria', isMaleChip: true,
                  selected: isMale, onChanged: onGenderChanged),
              const SizedBox(width: 10),
              _GenderChip(
                  label: 'Wanita', isMaleChip: false,
                  selected: isMale, onChanged: onGenderChanged),
            ],
          ),
        ...
        return Expanded(
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              color: done
                  ? AppTheme.accentGold
                  : current ? AppTheme.accentPurple : Colors.white12,
            ),
          ),
        );
      }),
