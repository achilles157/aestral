...
class BaziBranchRelationsCard extends StatelessWidget {
  ...
  Widget _harmonyRow(BaziHarmony h) {
    final resultColor = kBaziElementColors[h.resultElement] ?? AppTheme.accentGold;
    return Padding(
      padding: const EdgeInsets.only(bottom: 6),
      child: Row(children: [
        ...
        const Padding(
          ...
          child: Text('✦', style: TextStyle(fontSize: 14, color: Color(0xFFFBBF24))),
        ),
  ...
  Widget _triadRow(BaziTriad t) {
    ...
    return Padding(
      padding: const EdgeInsets.only(bottom: 6),
      child: Row(children: [
        ...t.pillarIndices.map((idx) => Padding(
      ...
      ...emptyBranches.map((b) => Padding(
            ...
            child: Container(
              ...
              child: Row(mainAxisSize: MainAxisSize.min, children: [
                Text(kBaziBranchSymbol[b],
                    style: GoogleFonts.playfairDisplay(
                        fontSize: 16, color: AppTheme.textMuted)),
                const SizedBox(width: 5),
                Text(kBaziBranchName[b],
                    style: GoogleFonts.outfit(
