...
void main() {
  testWidgets('SeasonalBanner renders active Mangsa info correctly', (
    WidgetTester tester,
  ) async {
    const mockMangsa = PranataMangsaModel(
      ...
      saranAktivitas: [
        'Declutter digital dan fisik',
        'Bersihkan meja kerja Anda',
      ],
    ...
    expect(
      find.text('Sang Pembersih Lahan (Ego-Death & Decluttering)'),
      findsOneWidget,
    );
    ...
    await tester.tap(
      find.text('Lihat Ramalan Karir, Asmara & Saran Aktivitas'),
    );
